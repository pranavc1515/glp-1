export const panelData = [
  {
    ...
    description:
      "Our GLP-1 program helps you lose up to 20% of your body weight. Clinically proven and backed by medical research.",
  },
  {
    id: 2,
    lightIcon: "/assets/images/template/icon-trophy.svg",
    darkIcon: "/assets/images/template/icon-trophy-dark.svg",
    altText: "medical-icon",
    title: "Medical Expertise",
    description:
      "Our team of endocrinologists and medical professionals provide personalized care and support throughout your weight loss journey.",
  },
  {
    id: 3,
    ...
    description:
      "We provide personalized treatment plans tailored to your metabolic type and health goals for safe, sustainable weight loss.",
  },
];
...
export const features = [
  {
    ...
    imgAlt: "GLP-1 weight loss injections and personalized care",
    title: "GLP-1 Weight Loss Injections with Expert Care",
    description:
      "Our medical platform provides GLP-1 injections with comprehensive support from endocrinologists. Get personalized treatment plans that are safe, effective, and sustainable for long-term weight loss.",
  },
  {
    id: 5,
    imgSrc: "/assets/images/template/feature-02.svg",
    imgAlt: "Complete weight loss program with medical support",
    title: "Complete Medical Weight Loss Program",
    description:
      "Beyond injections, we provide lifestyle coaching, smart devices, blood tests, and ongoing medical monitoring for optimal results.",
  ...
  },
  {
    ...
    imgAlt: "Safe and regulated medical weight loss",
    title: "Safe & Regulated Medical Treatment",
    description:
      "All treatments are prescribed and monitored by licensed endocrinologists. We ensure safety with regular check-ups, side effect management, and proper medication tapering.",
  },
];
...
export const features2 = [
  {
    ...
    description:
      "Get personalized consultations with endocrinologists specializing in weight management.",
  ...
  },
  {
    ...
    description:
      "Access to proven GLP-1 medications that help reduce appetite and promote weight loss.",
  ...
  },
  {
    ...
    description:
      "Monitor your weight loss journey with smart devices and regular medical check-ups.",
    backgroundColor: "bg-white dark:bg-gray-800",
  },
  {
    ...
    description:
      "Get support with meal planning, exercise, and habit formation for lasting results.",
    backgroundColor: "bg-white dark:bg-gray-800",
  },
];
...
export const featureItems = [
  {
    ...
    altText: "Fast and effective weight loss with GLP-1",
    title: "Fast and Effective Weight Loss with GLP-1",
    description:
      "Our GLP-1 program delivers proven results - up to 20% weight loss in clinical trials. Start seeing results within weeks with medical supervision.",
    linkText: "Learn more",
  ...
  },
  {
    ...
    altText: "Comprehensive medical support and monitoring",
    title: "Comprehensive Medical Support and Monitoring",
    description:
      "Get continuous care from endocrinologists with regular check-ups, blood tests, and personalized adjustments to your treatment plan.",
    linkText: "See medical team",
    icon: "unicon-course",
    reverseOrder: true,
  },
  {
    imageSrc: "/assets/images/template/home-four-feature-03.png",
    altText: "Smart tracking and lifestyle coaching",
    title: "Smart Tracking and Lifestyle Coaching",
    description:
      "Monitor your progress with smart scales, fitness tracking, and dedicated coaching support to build sustainable healthy habits.",
    linkText: "View tracking tools",
    icon: "unicon-volume-block-storage",
    reverseOrder: false,
  },
  {
    imageSrc: "/assets/images/template/home-four-feature-04.png",
    altText: "Safe medication management and tapering",
    title: "Safe Medication Management and Tapering",
    description:
      "Our medical team ensures safe treatment with proper side effect management and gradual medication tapering to maintain your weight loss.",
    linkText: "Safety protocol",
    icon: "unicon-model",
    reverseOrder: true,
  },
];
